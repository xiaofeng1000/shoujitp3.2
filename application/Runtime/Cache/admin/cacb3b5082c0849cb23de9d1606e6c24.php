		...
		<div id="usual1" class="usual">
			<div id="tab1" class="tabson">
				<ul class="forminfo">
	    			...
	    			<li>
	    				<label>价格<b>*</b></label>  
	    				<input name="" type="text" class="Dprice" value=""  style="width:518px;height:40px; border:1px solid #A7B5BC" />
	    			</li>
	    			<li>
	    				<label>&nbsp;</label>
	    				<input name="" type="button" class="btn" value="添加更换电池型号和价格"/>
	    			</li>
    			</ul>
			</div>
		</div>
...
$('.btn').click(function(){
	...
	$.ajax({
		type:'POST',
		url:'/shouji/admin.php/Battery/insert',
		data:{
			number:number,
			price:price,
		},
